...
test_that("high level works - parsing", {
  ...
  vcr::use_cassette("rl_common_names_parsing", {
...
test_that("high level works - not parsing", {
  ...
  vcr::use_cassette("rl_common_names_not_parsing", {
...
test_that("low level works", {
  ...
  vcr::use_cassette("rl_common_names_low_level", {
...
test_that("no results", {
  ...
  vcr::use_cassette("rl_common_names_no_results", {

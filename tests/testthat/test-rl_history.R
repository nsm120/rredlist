...
test_that("high level works - parsing", {
  ...
  vcr::use_cassette("rl_history_parsing", {
...
test_that("high level works - not parsing", {
  ...
  vcr::use_cassette("rl_history_not_parsing", {
...
test_that("high level works - by ID", {
  ...
  vcr::use_cassette("rl_history_by_id", {
...
test_that("high level works - region", {
  ...
  vcr::use_cassette("rl_history_by_region", {
...
test_that("low level works", {
  ...
  vcr::use_cassette("rl_history_low_level", {

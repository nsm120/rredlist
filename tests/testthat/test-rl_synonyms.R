...
test_that("high level works - parsing", {
  ...
  vcr::use_cassette("rl_synonyms_parsing", {
...
test_that("high level works - not parsing", {
  ...
  vcr::use_cassette("rl_synonyms_not_parsing", {
...
test_that("low level works", {
  ...
  vcr::use_cassette("rl_synonyms_low_level", {
...
test_that("no results", {
  ...
  vcr::use_cassette("rl_synonyms_no_results", {

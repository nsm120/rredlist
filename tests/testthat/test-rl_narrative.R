...
test_that("high level works - parsing", {
  ...
  vcr::use_cassette("rl_narrative_parsing", {
...
test_that("high level works - not parsing", {
  ...
  vcr::use_cassette("rl_narrative_not_parsing", {
...
test_that("low level works", {
  ...
  vcr::use_cassette("rl_narrative_low_level", {
...
test_that("no results", {
  ...
  vcr::use_cassette("rl_narrative_no_results", {
